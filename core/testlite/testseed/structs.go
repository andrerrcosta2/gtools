...
type StructIntSeeder struct{}

func (s StructIntSeeder) Seed() []int {
	size := rand.Intn(10)
	seed := make([]int, size)
	for i := 0; i < size; i++ {
		seed[i] = rand.Int()
...
func StructWithPointersNoNilFieldsAsValue() StructWithPointers {
	name := "Alice"
	data := &StructOneData{Name: "Bob"}
	return StructWithPointers{
		Name:   &name,
		Data:   data,
		Values: []int{1, 2, 3},
...
func StructWithPointersNoNilFieldsAsRef() *StructWithPointers {
	name := "Alice"
	data := &StructOneData{Name: "Bob"}
	return &StructWithPointers{
		Name:   &name,
...
func StructWithPointersAllNilFieldsAsValue() StructWithPointers {
	return StructWithPointers{
		Name:   nil,
		Data:   nil,
		Values: nil,
...
func StructWithPointersAllNilFieldsAsRef() *StructWithPointers {
	return &StructWithPointers{
		Name:   nil,
		Data:   nil,
		Values: nil,
...
func StructWithPointersSomeNilFieldsAsValue() StructWithPointers {
	name := "Alice"
	return StructWithPointers{
		Name:   &name,
		Data:   nil,
...
func StructWithPointersSomeNilFieldsAsRef() *StructWithPointers {
	name := "Alice"
	data := &StructOneData{Name: "Bob"}
	return &StructWithPointers{
		Name:   &name,
...
type StructWithPointersAndUnexportedFields struct {
	name   *string
	data   *StructOneData
	Values []int
	Config map[string]string
...
func StructWithPointersAndUnexportedsNoNilFieldsAsValue() StructWithPointersAndUnexportedFields {
	n := "Bob"
	d := &StructOneData{Name: "Bob"}
	return StructWithPointersAndUnexportedFields{
		name:   &n,
		data:   d,
		Values: []int{1, 2, 3},
		Config: map[string]string{"key": "value"},
...
func StructWithPointersAndUnexportedsNoNilFieldsAsRef() *StructWithPointersAndUnexportedFields {
	n := "Bob"
	d := &StructOneData{Name: "Bob"}
	return &StructWithPointersAndUnexportedFields{
		name:   &n,
...
func StructWithPointersAndUnexportedsSomeNilFieldsAsValue() StructWithPointersAndUnexportedFields {
	n := "Bob"
	return StructWithPointersAndUnexportedFields{
		name:   &n,
		data:   nil,
...
func StructWithPointersAndUnexportedsSomeNilFieldsAsRef() *StructWithPointersAndUnexportedFields {
	d := &StructOneData{Name: "Bob"}
	return &StructWithPointersAndUnexportedFields{
		name:   nil,
		data:   d,
...
func StructWithPointersAndUnexportedsAllNilFieldsAsValue() StructWithPointersAndUnexportedFields {
	return StructWithPointersAndUnexportedFields{
		name:   nil,
		data:   nil,
		Values: nil,
...
func StructWithPointersAndUnexportedsAllNilFieldsAsRef() *StructWithPointersAndUnexportedFields {
	return &StructWithPointersAndUnexportedFields{
		name:   nil,
		data:   nil,
		Values: nil,
...
func NewStructStringer(data any) *StructStringer {
	return &StructStringer{data}
}
