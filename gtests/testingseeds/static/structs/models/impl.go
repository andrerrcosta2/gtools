...
func FloatAsValue(v float64) Float {
	return Float{}
}

func FloatAsRef(v float64) *Float {
...
func OneDataAsRef(data string) *OneData {
	return &OneData{
		Data: data,
	}
}

func OneDataAsValue(data string) OneData {
	return OneData{
		Data: data,
	}
}
...
func TwoDataAsRef(d1 string, d2 int) *TwoData {
	return &TwoData{
		Name: d1,
		Age:  d2,
	}
...
var ThreeDataZeroInst = new(ThreeData)

func ThreeDataAsRef(d1 string, d2 int, d3 float64) *ThreeData {
	return &ThreeData{
		Data1: d1,
		Data2: d2,
		Data3: d3,
...
func ThreeDataAsValue(d1 string, d2 int, d3 float64) ThreeData {
	return ThreeData{
		Data1: d1,
		Data2: d2,
		Data3: d3,
...
func ThreeDataAsRandRef() *ThreeData {
	return &ThreeData{
		Data1: random.SingleOf[string](),
		Data2: random.Int(1, 0, 100).At(0),
		Data3: random.Float64(1, 0, 100).At(0),
	}
}

func ThreeDataAsRandValue() ThreeData {
	return ThreeData{
		Data1: random.SingleOf[string](),
		Data2: random.Int(1, 0, 100).At(0),
		Data3: random.Float64(1, 0, 100).At(0),
...
func (t *ThreeData) String() string {
	return t.Data1
}

func (t *ThreeData) Int() int {
	return t.Data2
}

func (t *ThreeData) Float() float64 {
	return t.Data3
}
