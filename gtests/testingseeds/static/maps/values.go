...
func primitivesPtrKeys() []interface{} {
	return []interface{}{
		// bool keys
		map[*bool]bool{}, map[*bool]int{}, map[*bool]int8{}, map[*bool]int16{}, map[*bool]int32{}, map[*bool]int64{},
		map[*bool]uint{}, map[*bool]uint8{}, map[*bool]uint16{}, map[*bool]uint32{}, map[*bool]uint64{}, map[*bool]uintptr{},
...
func primitivesPtrValues() []interface{} {
	return []interface{}{
		// bool keys
		map[bool]*bool{}, map[bool]*int{}, map[bool]*int8{}, map[bool]*int16{}, map[bool]*int32{}, map[bool]*int64{},
		map[bool]*uint{}, map[bool]*uint8{}, map[bool]*uint16{}, map[bool]*uint32{}, map[bool]*uint64{}, map[bool]*uintptr{},
...
func primitivesPtrKeysAndValues() []interface{} {
	return []interface{}{
		// bool keys
...
func ofValues() []interface{} {
	return slices.Concat(edgeValues(), primitivesPtrKeysAndValues(), primitivesPtrValues(),
		primitivesPtrKeys(), primitives())
}
