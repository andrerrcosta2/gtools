...
require (
	...
	github.com/andrerrcosta2/gtools/datastr v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/gflux v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/gtests v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/gvalidation v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/numbers v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/patterns v0.0.2-alpha.2
	github.com/andrerrcosta2/gtools/reflect4 v0.0.2-alpha.2
)

require (
	github.com/andrerrcosta2/gtools/core/data v0.0.2-alpha.2 // indirect
	github.com/andrerrcosta2/gtools/core/domain v0.0.2-alpha.2 // indirect
	github.com/andrerrcosta2/gtools/gflux/core v0.0.2-alpha.2 // indirect
	github.com/andrerrcosta2/gtools/gflux/obs v0.0.2-alpha.2 // indirect
