...
require (
	...
	github.com/andrerrcosta2/gtools/gflux/obs v0.0.2-alpha
// github.com/andrerrcosta2/gtools/gflux/event v0.0.0-1-modular
)

require (
	github.com/andrerrcosta2/gtools/core/data v0.0.2-alpha // indirect
	github.com/andrerrcosta2/gtools/core/domain v0.0.2-alpha // indirect
