...
require (
	github.com/andrerrcosta2/gtools/gflux/core v0.0.0-1-modular
	github.com/andrerrcosta2/gtools/gflux/obs v0.0.0-1-modular
...
require (
	...
	github.com/andrerrcosta2/gtools/core/domain v0.0.1-modular // indirect
