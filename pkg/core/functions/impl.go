...
// This function serves as an identity function for any type.
func BiIdentity[T any, U any](x T, z U) (T, U) {
	return x, z
}

// TriIdentity returns the input value unchanged.
// This function serves as an identity function for any type.
func TriIdentity[T any, U any, V any](x T, y U, z V) (T, U, V) {
	return x, y, z
}

// ImplementedEquality returns true if the two values are implemented equal, false otherwise.
func ImplementedEquality[T gtools.ComparableOf](x T, y T) bool {
	return x.Equal(y)
}

func MultipleImplementedEquality[T gtools.ComparableOf](values ...T) bool {
