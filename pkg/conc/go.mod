...
require (
	...
	github.com/andrerrcosta2/gtools/core/data v0.0.2-alpha.1
	github.com/andrerrcosta2/gtools/core/domain v0.0.2-alpha.1
	github.com/andrerrcosta2/gtools/gflux/core v0.0.2-alpha.1
	github.com/andrerrcosta2/gtools/gtests v0.0.2-alpha.1
)

require (
	github.com/andrerrcosta2/gtools/core/seeders v0.0.2-alpha.1 // indirect
