...
import "github.com/andrerrcosta2/gtools/ranges"
...
func (s *IntSentinel) Walk(val int) bool {
	s.value += val
	return true
}
...
// Ranged is a sentinel with a RightClosed range
...
func RangedCloseable(startValue int, rng ranges.Range) *RangedCloseableSentinel {
